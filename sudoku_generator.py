...
class SudokuGenerator:
    ...
    def is_valid(self, row, col, num):
        ...
        return self.valid_in_row(row, num) and self.valid_in_col(col, num) and self.valid_in_box(row_start, col_start,
                                                                                                 num)
    ...
    def fill_diagonal(self):
        for i in range(self.box_length):
            self.fill_box(self.box_length * i, self.box_length * i)
